    ...
    <div className="bg-white p-6 print:p-4">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          ...
          <div><span className="text-gray-500">Initial Count:</span> <span className="font-medium">{Number(data.flock.initialCount ?? 0).toLocaleString()}</span></div>
          <div><span className="text-gray-500">Current Count:</span> <span className="font-medium">{Number(data.flock.currentCount ?? 0).toLocaleString()}</span></div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <div className="bg-amber-50 rounded-lg p-3 text-center">
          <div className="text-2xl font-bold text-amber-700">{Number(data.stats.totalEggs ?? 0).toLocaleString()}</div>
