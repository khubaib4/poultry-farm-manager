...
- **Routing**: `react-router-dom` v7 with `HashRouter`
  ...
  - Farm routes: `/farm/dashboard`, `/farm/daily-entry`, `/farm/daily-entry/history`, `/farm/flocks`, `/farm/flocks/new`, `/farm/flocks/:flockId`, `/farm/flocks/:flockId/edit`, `/farm/pricing`, `/farm/inventory`, `/farm/inventory/new`, `/farm/inventory/:itemId/edit`, `/farm/alerts`, `/farm/vaccinations`, `/farm/vaccinations/template`, `/farm/expenses`, `/farm/expenses/new`, `/farm/expenses/:expenseId/edit`, `/farm/revenue`, `/farm/finances`, `/farm/finances/report`, `/farm/reports`, `/farm/settings`
