...
- **Routing**: `react-router-dom` v7 with `HashRouter`
  ...
  - Farm routes: `/farm/dashboard`, `/farm/daily-entry`, `/farm/daily-entry/history`, `/farm/flocks`, `/farm/flocks/new`, `/farm/flocks/:flockId`, `/farm/flocks/:flockId/edit`, `/farm/pricing`, `/farm/inventory`, `/farm/vaccinations`, `/farm/expenses`, `/farm/reports`, `/farm/settings`
